...
# create user
php artisan ti
\App\Models\User::factory()->create(['email' => 'borisvukaso@gmail.com', 'password' => '12345678']) 

# artisan
php artisan make:controller {name}
php artisan make:model {name}       (use -m flag to add migration file and -f flag for factory)
